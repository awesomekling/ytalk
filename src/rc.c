  ...
  int *rc, *ra;
{
	...
	*ra = 0;
    ...
    if(strcmp(c, "black"  ) == 0) *rc = COLOR_BLACK;
    else if(strcmp(c, "red"    ) == 0) *rc = COLOR_RED;
    else if(strcmp(c, "green"  ) == 0) *rc = COLOR_GREEN;
    else if(strcmp(c, "yellow" ) == 0) *rc = COLOR_YELLOW;
    else if(strcmp(c, "blue"   ) == 0) *rc = COLOR_BLUE;
    else if(strcmp(c, "magenta") == 0) *rc = COLOR_MAGENTA;
    else if(strcmp(c, "cyan"   ) == 0) *rc = COLOR_CYAN;
    else if(strcmp(c, "white"  ) == 0) *rc = COLOR_WHITE;
    else
	return -1;
    return 0;
}
